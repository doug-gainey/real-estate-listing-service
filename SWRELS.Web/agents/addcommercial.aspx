<%@ Page Title="Add Commercial Listing" Language="C#" MasterPageFile="~/agents/agent.master" AutoEventWireup="true" CodeFile="addcommercial.aspx.cs" Inherits="agents_addcommercial" %>
...
<asp:Content ID="cntContentArea" ContentPlaceHolderID="cphContentArea" runat="Server">
    <asp:PlaceHolder ID="phGeneral" runat="server">
        ...
        <div class="rightcolumn">
            ...
            <uc:TextField ID="tfFinishAllowPerSqFt" Label="Finish Allowance Per Square Feet" DataType="Double" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfPercentRent" Label="Percentage Rent" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:CheckBoxField ID="cbfWillRemodel" Label="Landlord Will Remodel" runat="server" />
        </div>
    </asp:PlaceHolder>
    ...
    <asp:PlaceHolder ID="phDetails" Visible="false" runat="server">
        ...
        <div class="leftcolumn">
            ...
            <uc:TextField ID="tfTotalBuildingSqFt" Label="Total Building Square Feet" DataType="Integer" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfTotalAvailableSqFt" Label="Total Available Square Feet" DataType="Integer" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfMinSqFt" Label="Minimum Available Square Feet" DataType="Integer" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfMaxContiguousSqFt" Label="Maximum Available Contiguous Square Feet" DataType="Integer" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfNumDocks" Label="Number of Docks" MaxLength="3" DataType="Integer" Operator="LessThanEqual" ValueToCompare="127" runat="server" />
            <uc:TextField ID="tfDockSize" Label="Dock Size" MaxLength="7" runat="server" />
            <uc:TextField ID="tfBaySize" Label="Bay Size" MaxLength="7" runat="server" />
            <uc:TextField ID="tfNumDriveInDoors" Label="Number of Drive-In Doors" MaxLength="3" DataType="Integer" Operator="LessThanEqual" ValueToCompare="127" runat="server" />
            <uc:TextField ID="tfDriveInDoorSize" Label="Drive-In Door Size" MaxLength="7" runat="server" />
            <uc:TextField ID="tfNumUnits" Label="Number of Units" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfNumFloorsAboveGround" Label="Number of Floors Above Ground" MaxLength="3" DataType="Integer" Operator="LessThanEqual" ValueToCompare="127" runat="server" />
        </div>
        <div class="rightcolumn">
            <uc:TextField ID="tfTotalParking" Label="Total Parking" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfParkRate" Label="Park Rate Per 1000" DataType="Double" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfTrafficCount" Label="Traffic Count Per Day" DataType="Integer" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfCeilingHeight" Label="Ceiling Height" MaxLength="6" runat="server" />
            <uc:TextField ID="tfYearBuilt" Label="Year Built" ValdationExpression="^(19|20)\d\d$" Format="yyyy" runat="server" />
            <uc:TextField ID="tfYearRemodeled" Label="Year Remodeled" ValdationExpression="^(19|20)\d\d$" Format="yyyy" runat="server" />
            ...
            <uc:TextField ID="tfUseCode" Label="Use Code" MaxLength="3" runat="server" />
            <uc:TextField ID="tfZoning" Label="Zoning" MaxLength="6" runat="server" />
            <uc:TextField ID="tfOccupancyRate" Label="Occupancy Rate" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfNearInterchange" Label="Near Interchange" MaxLength="10" runat="server" />
