<%@ Page Title="Add Multi-Family Listing" Language="C#" MasterPageFile="~/agents/agent.master" AutoEventWireup="true" CodeFile="addmultifamily.aspx.cs" Inherits="agents_addmultifamily" %>
...
<asp:Content ID="cntContentArea" ContentPlaceHolderID="cphContentArea" runat="Server">
    ...
    <asp:PlaceHolder ID="phDetails" Visible="false" runat="server">
        ...
        <div class="leftcolumn">
            ...
            <uc:TextField ID="tfMinSquareFootage" Label="Minimum Square Footage" DataType="Integer" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfMaxSquareFootage" Label="Maximum Square Footage" DataType="Integer" Operator="DataTypeCheck" runat="server" />
            <uc:TextField ID="tfNumElevators" Label="Number of Elevators" MaxLength="3" DataType="Integer" Operator="LessThanEqual" ValueToCompare="127" runat="server" />
        ...
        <div class="rightcolumn">
            ...
            <uc:TextField ID="tfEfficiencyRent" Label="Efficiency Rent" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfOneBedroomRent" Label="One Bedroom Rent" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfTwoBedroomRent" Label="Two Bedroom Rent" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfThreeBedroomRent" Label="Three Bedroom Rent" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfFourBedroomRent" Label="Four Bedroom Rent" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
            <uc:TextField ID="tfFiveBedroomRent" Label="Five Bedroom Rent" MaxLength="5" DataType="Integer" Operator="LessThanEqual" ValueToCompare="32767" runat="server" />
        </div>
    </asp:PlaceHolder>
