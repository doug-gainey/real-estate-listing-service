...
public partial class agents_addresidential : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cbfNewConstruction.CheckBox.Attributes.Add("onchange", String.Format("toggleField('{0}')", tfCompletionDate.ClientID));
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        using (SwrelsFacade facade = new SwrelsFacade())
        {
            ...
            string taxDistrict = Global.GetString(tfTaxDistrict.Text);
            ...
            byte? numBedrooms = Global.GetByte(tfNumBedrooms.Text);
            byte? numBathrooms = Global.GetByte(tfNumBathrooms.Text);
            byte? numHalfBathrooms = Global.GetByte(tfNumHalfBathrooms.Text);
            bool hasLivingRoom = cbfLivingRoom.Checked;
            bool hasFamilyRoom = cbfFamilyRoom.Checked;
            bool hasGreatRoom = cbfGreatRoom.Checked;
            bool hasDen = cbfDen.Checked;
            bool hasRecreationRoom = cbfRecreationRoom.Checked;
            bool hasDiningRoom = cbfDiningRoom.Checked;
            bool hasEatingSpace = cbfEatingSpace.Checked;
            bool hasUtility = cbfUtility.Checked;
            bool isWaterfront = cbfWaterfront.Checked;
            bool isNewConstruction = cbfNewConstruction.Checked;
            DateTime? completionDate = Global.GetDate(tfCompletionDate.Text);
            bool priorTo = cbfPriorTo.Checked;
            short? yearBuilt = Global.GetInt16(tfYearBuilt.Text);
            decimal? yearlyTaxes = Global.GetDecimal(tfYearlyTaxes.Text);
            string lotSize = Global.GetString(tfLotSize.Text);
            decimal? acreage = Global.GetDecimal(tfAcreage.Text);
            int? squareFootage = Global.GetInt32(tfSquareFootage.Text);
            int? finishedLivingSpace = Global.GetInt32(tfFinishedLivingSpace.Text);
            ...
            // Save to the residential table
            ResidentialListing residentialListing = new ResidentialListing
                                                        {
                                                            Baths = numBathrooms,
                                                            Bedrooms = numBedrooms,
                                                            CompleteDate = completionDate,
                                                            Den = hasDen,
                                                            DiningRoom = hasDiningRoom,
                                                            EatingSpc = hasEatingSpace,
                                                            FamilyRoom = hasFamilyRoom,
                                                            FinLivingSpace = finishedLivingSpace,
                                                            GreatRoom = hasGreatRoom,
                                                            HalfBaths = numHalfBathrooms,
                                                            Listing = listing,
                                                            LivingRoom = hasLivingRoom,
                                                            NewConst = isNewConstruction,
                                                            PriorTo = priorTo,
                                                            RecRoom = hasRecreationRoom,
                                                            SchoolDistrict = schoolDistrict,
                                                            SqFoot = squareFootage,
                                                            TaxDistrict = taxDistrict,
                                                            Utility = hasUtility,
                                                            YearBuilt = yearBuilt,
                                                            YearlyTaxes = yearlyTaxes
                                                        };
            facade.Save(residentialListing);
    ...
    private void PopulatePropertyTypes()
    {
        using (SwrelsFacade facade = new SwrelsFacade())
        {
            IList<PropertyType> propertyTypes = facade.GetPropertyTypes(ListingType.Residential);
    ...
    private void PopulateFeatures()
    {
        using (SwrelsFacade facade = new SwrelsFacade())
        {
            ...
            IList<ResidentialFeature> features = facade.GetList<ResidentialFeature>();
