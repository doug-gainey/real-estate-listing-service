<%@ Page Title="SWRELS.com - Privacy Policy" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="privacy.aspx.cs" Inherits="privacy" %>
...
<asp:Content ID="cntLeftColumn" ContentPlaceHolderID="cphLeftColumn" runat="Server">
    ...
    <ul>
        ...
        <li>
            <strong>Privacy Contact Information</strong><br />
            If you have any questions, concerns, or comments about our privacy policy you may contact us using the information below.<br /><br />
            By e-mail: <a href="mailto:info@swrels.com">info@swrels.com</a>
        </li>
    </ul>
    <p>
        <em>We reserve the right to make changes to this policy. Any changes to this policy will be posted.</em>
    </p>
</asp:Content>
